...
class MoonpyLC(object):
	...
	from _mp_attributes import make_NEA_dict, make_vespa_starini, make_vespa_fppini, make_vespa_photfile, run_vespa, find_transit_quarters, find_aliases, get_coords, find_planet_row, get_properties, get_databases, find_taus, mystery_solver, find_neighbors, find_TTVs, get_future_transits
