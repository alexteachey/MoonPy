...
#### THIS SCRIPT IS A SLIGHTLY MODIFIED VERSION OF Jingjing Chen's FORECASTER CODE
#### found here: https://github.com/chenjj2/forecaster
#### modifications were made for Python3, and to make invoking it (with and without MoonPy) a bit easier for me.


scriptdir = os.path.realpath(__file__)
scriptdir = scriptdir[:scriptdir.find('/mr_forecast.py')]
...
#dirpath = 
## read parameter file
hyper_file = scriptdir+'/fitting_parameters.h5'
...
def Mpost2R(mass, unit='Earth', classify='No'):
	...
	classify: string (optional)
		...
		Result will be print	ed, not returned.
...
def Mstat2R(mean, std, unit='Earth', sample_size=int(1000), classify = 'No'):	
	"""
